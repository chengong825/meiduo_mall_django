...
from carts.serializers import CartSKUSerializer, CartSerializer, CartDeleteSerializer, CartSelectAllSerializer
...
class CartView(APIView):
    ...
    def post(self, request):
        ...
        if user is not None and user.is_authenticated:
            ...
            if cart is not None:
                print(cart.encode())
                print(base64.b64decode(cart.encode()))
                print(pickle.loads(base64.b64decode(cart.encode())))
