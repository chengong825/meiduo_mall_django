...
class Goods(BaseModel):
    ...
    # parent = models.ForeignKey(GoodsCategory, on_delete=models.SET_NULL, related_name='subs', null=True, blank=True,
    #                            verbose_name='上级类别')
...
class SKU(BaseModel):
    ...
    goods = models.ForeignKey(Goods, on_delete=models.CASCADE, verbose_name='商品')
    # category=models.CharField(default=Goods,max_length=10,verbose_name='从属类别')
