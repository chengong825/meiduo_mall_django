let vm = new Vue({
    ...
    methods: {
        ...
        check_receiver: function () {
            this.error_receiver = !this.form_address.receiver;
        },
        check_place: function () {
            this.error_place = !this.form_address.place;
        },
        check_mobile: function () {
            let re = /^1[345789]\d{9}$/;
            this.error_mobile = !re.test(this.form_address.mobile);
        },
        check_email: function () {
            if (this.form_address.email) {
                let re = /^[a-z0-9][\w\.\-]*@[a-z0-9\-]+(\.[a-z]{2,5}){1,2}$/;
                this.error_email = !re.test(this.form_address.email);
            }
        },
        // 保存地址
